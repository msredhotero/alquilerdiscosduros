...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-08-2018 a las 20:58:18
...
ALTER TABLE `dbdiscos`
 ADD PRIMARY KEY (`iddisco`), ADD KEY `fk_discos_peliculas_idx` (`refpeliculas`);
...
--
ALTER TABLE `tbtransporteterceros`
MODIFY `idtransportetercero` int(11) NOT NULL AUTO_INCREMENT;
--
