...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../peliculas/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Peliculas",$_SESSION['refroll_predio'],'');


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerPeliculasPorId($id);
...
$eliminar = "eliminarPeliculas";

$modificar = "modificarPeliculas";
...
$cadRef 	= $serviciosFunciones->devolverSelectBoxActivo($resVar1,array(1),'', mysql_result($resResultado,0,'refclientes'));
