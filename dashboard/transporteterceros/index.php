...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../transporteterceros/');
//*** FIN  ****/
...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Transporte Terceros",$_SESSION['refroll_predio'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Transporte Terceros";

$plural = "Transporte Terceros";

$eliminar = "eliminarTransporteterceros";

$insertar = "insertarTransporteterceros";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerTransporteterceros(),3);
