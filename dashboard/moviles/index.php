...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../moviles/');
//*** FIN  ****/
...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Moviles",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarMoviles";

$insertar = "insertarMoviles";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerMoviles(),3);
