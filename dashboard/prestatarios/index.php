...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../prestatarios/');
//*** FIN  ****/
...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Prestatarios",$_SESSION['refroll_predio'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Prestatario";

$plural = "Prestatarios";

$eliminar = "eliminarPrestatarios";

$insertar = "insertarPrestatarios";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerPrestatarios(),7);
